...
_USER_TABLES = [
    ...
    ("investment_profiles", InvestmentProfileModel),
    ("investment_habit_snapshots", InvestmentHabitSnapshotModel),
]
...
class PrivacySummary(BaseModel):
    ...
    push_devices: int = 0
    investment_profiles: int = 0
    investment_habit_snapshots: int = 0
